        ...
        <section className='min-h-screen bg-gray-50'>
            <div className='p-4 bg-white shadow-sm border-b flex items-center justify-between'>
                ...
                <button
                    ...
                    className='bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 text-sm font-medium rounded shadow'
                >
                    + Add Category
                </button>
            </div>
            ...
            <div className='p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6'>
                {categoryData.map((category) => (
                    <div
                        className='bg-white shadow rounded-lg overflow-hidden border hover:shadow-lg transition-all duration-200'
                        key={category._id}
                    >
                        <img
                            src={category.image}
                        ...
                        <div className='p-3 text-center'>
                            <h3 className='text-gray-700 font-semibold truncate'>{category.name}</h3>
                        </div>
                        <div className='flex border-t'>
                            <button
                                ...
                                className='flex-1 text-sm font-medium text-green-600 hover:bg-green-50 py-2'
                            >
                                Edit
                            </button>
                            <button
                                ...
                                className='flex-1 text-sm font-medium text-red-600 hover:bg-red-50 py-2 border-l'
                            >
                                Delete
                            </button>
                        </div>
